                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onBlur={handleBlur}
                        className={`${errors.firstName ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors`}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`${errors.lastName ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors`}
                        disabled={isSubmitting}
                      />
                      {errors.lastName && (
                        <motion.p
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={`${errors.email ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors`}
                      disabled={isSubmitting}
                    />
                    {errors.email && (
                      <motion.p
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onBlur={handleBlur}
                      maxLength={14}
                      className={`${errors.phone ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors`}
                      disabled={isSubmitting}
                    />
                    {errors.phone && (
                      <motion.p
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={`${errors.company ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors`}
                      disabled={isSubmitting}
                    />
                    {errors.company && (
                      <motion.p
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Textarea
                        ...
                        onBlur={handleBlur}
                        maxLength={1000}
                        className={`${errors.message ? "border-destructive focus:border-destructive focus:ring-destructive" : "border-primary/20"} transition-colors pr-16`}
                        disabled={isSubmitting}
                      />
