    ...
    features: [
      {
        ...
        description: "Complete customer profiles with contact information and preferences",
      },
      {
        title: "Credit Limits:",
      ...
      {
        title: "Order History:",
        description: "Complete transaction history with order and payment tracking",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: "Complete supplier information with contact details and certifications",
      },
      {
        title: "Purchase History:",
        description: "Track purchase orders, delivery performance, and payment terms",
      },
      {
        title: "Performance Tracking:",
        description: "Monitor supplier performance including delivery times and quality ratings",
      },
    ],
  },
];
...
function ManagementCard({ card, index }: { card: ManagementCard; index: number }) {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl shadow-primary/10 border border-primary/10 overflow-hidden">
        <div className="relative bg-muted overflow-hidden">
          ...
          <div className="relative w-full h-full flex items-center justify-center aspect-4/3">
            <Image
              src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=700&fit=crop&q=80"
