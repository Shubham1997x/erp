...
export function CTASection() {
  ...
  const handleStartTrial = () => {
    ...
    showToast("Great choice! We'll set up your free trial shortly.", "success", 3000);
  };
  ...
  const handleScheduleDemo = () => {
    ...
    showToast("We'll schedule your demo and contact you soon!", "success", 3000);
  };
        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative inline-flex items-center justify-center text-base font-medium px-8 py-6 bg-primary hover:bg-primary/90 text-white rounded-lg transition-all duration-300 cursor-pointer overflow-hidden shadow-lg shadow-primary/30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center text-base font-medium px-8 py-6 border-2 border-white/30 bg-transparent text-white hover:bg-white/10 hover:border-white/50 hover:text-white rounded-lg transition-all duration-300 cursor-pointer backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
