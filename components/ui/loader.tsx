  ...
  return (
    <div className="w-fit h-fit flex items-center justify-center">
      <div className="w-[200px] h-[100px] flex flex-col relative items-center justify-end overflow-x-hidden">
        {/* Truck Body */}
        <div className="w-[130px] h-fit mb-1.5 animate-truck-bounce">
          <svg
        ...
        {/* Truck Tires */}
        <div className="w-[130px] h-fit flex items-center justify-between px-2.5 pl-4 absolute bottom-0">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 30 30"
        ...
        <svg
          ...
          version="1.1"
          fill="#000000"
          className="absolute bottom-0 -right-[90%] h-[90px] animate-road-move"
        >
